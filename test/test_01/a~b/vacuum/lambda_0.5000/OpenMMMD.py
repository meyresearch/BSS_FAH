...
topfile = Parameter("topfile", "somd.prm7",
                    """File name of the topology file containing the system to be simulated.""")

crdfile = Parameter("crdfile", "somd.rst7",
...
cutoff_type = Parameter("cutoff type", "cutoffnonperiodic", """The cutoff method to use during the simulation.""")
...
serialise_openmm_file = Parameter("serialise_openmm_file", "openmm_system.xml.bz2", """If specified write bz2 compressed serialised OpenMM system""")
...
def runFreeNrg():
    ...
    if serialise_openmm_file.val is not None:
        ...
        with bz2.open(serialise_openmm_file.val, 'wt') as openmm_file:
